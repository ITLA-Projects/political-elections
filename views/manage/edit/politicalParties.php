    ...
    <div class="album py-5 bg-light">
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          ...
          <form enctype="multipart/form-data" action="<?php echo constant('URL') ?>politicalParties/edit" method="POST" class="bg-white p-4 rounded-lg shadow">
            <input type="hidden" name="id" value="<?php echo $this->entity->id ?>">
            <input type="hidden" name="photo" value="<?php echo $this->entity->logo ?>">
